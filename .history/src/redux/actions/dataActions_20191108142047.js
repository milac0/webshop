...
export const getProducts = (page, name) => dispatch => {
  name = 'doll'
  const url = !!name ? `https://api.bestbuy.com/v1/products((search=\"doll\"))?apiKey=${process.env.REACT_APP_API_KEY}&sort=name.asc&show=name&pageSize=12&page=${page}&format=json`
